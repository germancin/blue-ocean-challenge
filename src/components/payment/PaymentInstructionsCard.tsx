			...
			<CardContent className="space-y-6">
				...
				<div className="text-center">
					...
					<div className="flex items-center justify-center gap-2">
						...
						<button onClick={() => copyToClipboard(amount.toString(), 'amount')} className="p-2 hover:bg-gray-100 rounded-full transition-colors" aria-label="Copy amount to clipboard">
					...
					<div className="relative flex items-center justify-center gap-2">
						...
						<button onClick={() => copyToClipboard(merchantAddress, 'address')} className="p-2 hover:bg-gray-100 rounded-full transition-colors" aria-label="Copy address to clipboard">
