...
const PrizeDistributionTable = () => {
    ...
    const winnersTable = [
        ...
        { position: '21°-50°', winners: '30', prize: '$40', total: '$1,200' },
        { position: '51°-57°', winners: '7', prize: '$35', total: '$245' }
    ];
    ...
    return (
        <div id="distribution" className="bg-navy py-20 relative overflow-hidden">
            <div
                ...
                style={{ backgroundImage: "url('/lovable-uploads/f72cf336-f7f5-4f48-b178-7503ef515628.png')" }}
            />
