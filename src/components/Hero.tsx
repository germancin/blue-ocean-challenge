					...
					<div className="text-white space-y-8 animate-fade-in order-1 md:order-1 text-center md:text-left">
						<div className="space-y-4">
							<div className="inline-block bg-bright-blue/20 backdrop-blur-sm px-4 py-2 rounded-full">
								<span className="text-bright-blue font-semibold">🏆 Torneo de Trading 2025</span>
							</div>
							<h1 className="text-4xl md:text-6xl font-bold leading-tight bg-gradient-to-r from-white via-bright-blue to-white bg-clip-text text-transparent animate-pulse">150 traders, 33% de posibilidades de éxito, ¡y el resto depende de ti!</h1>
						</div>
							...
							<Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
								<DialogTrigger asChild>
									<button className="group relative overflow-hidden bg-bright-blue hover:bg-bright-blue/90 text-white px-8 py-4 rounded-xl flex items-center space-x-2 transition-all duration-300 animate-scale-in font-sans shadow-lg shadow-bright-blue/20">
										<span className="relative z-10 font-semibold">Únete al Evento</span>
								...
								<DialogContent className="sm:max-w-[425px] bg-[#1A1F2C] backdrop-blur-sm p-8 rounded-xl shadow-xl border border-white/10">
									<DialogHeader>
										<DialogTitle className="text-3xl font-bold text-center text-white mb-2">¡Desbloquea tu potencial de trading hoy! 🚀</DialogTitle>
									</DialogHeader>
									<div className="mt-4">
										<SubscriptionForm onSuccess={() => setIsDialogOpen(false)} />
										<p className="text-center text-sm text-gray-400 mt-4">Únete a nuestra confiable comunidad de traders. Tus datos están seguros y solo te enviaremos actualizaciones de torneos y noticias esenciales. ✨</p>
									</div>
								</DialogContent>
							</Dialog>
						</div>
