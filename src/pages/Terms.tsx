    ...
    <main className="min-h-screen bg-light-gray">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            <h2 className="text-2xl font-semibold mb-4">1. Contest Overview</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">3. Contest Rules</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4">4. Prize Distribution</h2>
