					...
					<div className="flex flex-col md:flex-row items-center gap-8">
						...
						<div className="md:w-1/2">
							...
							<div className="flex gap-4 mt-6">
								<button className="bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-all duration-300">
									{t("copyTrade.trader.finalCta.button")}
								</button>
							</div>
						</div>
					</div>
